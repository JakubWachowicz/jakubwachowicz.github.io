  ...
  return (
    <div id="about" className="w-full h-screen flex items-center justify-center bg-gray-100 p-8 pt-16">
      <div className="text-center">
        ...
        Check out my CV to see more about what I do! <br></br> <a target="_black" href={cv} ><button className='transition-transform transform hover:scale-105 bg-black rounded-full font-bold mb-4 text-white p-3 m-3'>My Curriculum Vitae</button></a>
        </p>
